...
public class Lab_4_2 {
    public static void main(String[] args) {
        ...
        int num1, num2; // ตัวเเปรที่เก็บค่าที่ป้อนเข้ามาทาง Keyboard มาเป็นตัวเลขจากการถูกการเเปลงจาก String มา
        ...
        boolean done = true; //ตัวเเปล Boolean ที่เก็บค่าจริงกับเท็จ หากผู้ใช้กรอกเครื่องหมายทางคณิตศาสตร์ไม่ถูกต้องจะเป็น False
        ...
        */
        ...
        /*
         * เช็คตัวเเปร done จาก default จะถูกกำหนดไว้เป็น True หากเช็ค Case เเล้วไม่ตรง done จะเท่ากับ false
         * if (done) หมายถึง  ถ้า (เงื่อนไขเป็นจริง) จะโชว์ผลลัพธ์ตามด้านล่างเเต่ถ้าไม่จะเเสดง  Error Not Found
         */
        if (done)
